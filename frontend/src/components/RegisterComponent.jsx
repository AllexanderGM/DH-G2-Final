...
const RegisterComponent = () =>{
  ...
  return (
    ...
    />
        ...
        <form>
          <Input isRequired label="Nombre" labelPlacement="outside" name="nombre" placeholder="Ingresa tu nombre" type="text" className="mb-4"/>
          <Input isRequired label="Apellido" labelPlacement="outside" name="apellido" placeholder="Ingresa tu apellido" type="text" className="mb-4"/>
          <Input isRequired
      ...
      />
      <div className="mb-4">
      <Input isRequired type="password" label="Contraseña" labelPlacement="outside" placeholder="********" value={password} onChange={handlePasswordChange} className="mb-4"/>
      {error && <p className="text-sm text-red-500">{error}</p>}
      </div>
      <Input isRequired label="Pais" labelPlacement="outside" name="pais" placeholder="Pais" type="text" className="mb-4"/>
      <BrandButton  variant="solid" color="brandColor" className="w-full">Registrarse</BrandButton >
        </form>
        <p className="text-sm text-gray-600 text-center mt-4">
          ¿Ya tienes cuenta? <Link to="/log" className="text-primary-500 hover:underline">Inicia sesión aquí</Link>
        </p>
        </div>
      </Card>
    </div>
